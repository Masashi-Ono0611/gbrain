...
export const HOLDER_REGEX = new RegExp(
  // Page slugs accept uppercase; take holders retain their lowercase contract.
  `^(?!.*\\p{Lu})(?:world|brain|(?:people|companies)/${SLUG_SEGMENT_PATTERN.source}|${SLUG_SEGMENT_PATTERN.source})$`,
